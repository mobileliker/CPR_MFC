...
CPRDoc.h，CPRDoc.cpp - 文档
这些文件包含 CCPRDoc 类。编辑这些文件可以添加特殊文档数据并可实现文件保存和加载(通过 CCPRDoc::Serialize)。

CPRView.h，CPRView.cpp - 文档的视图
这些文件包含 CCPRView 类。
CCPRView 对象用于查看 CCPRDoc 对象。

res\CPRDoc.ico
这是图标文件，它用作 CCPRDoc 类的 MDI 子窗口的图标。此图标包括在主要资源文件 CPR.rc 中。
